      ...
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="section-subtitle">
            Real-world AWS builds. (You can add items in <code>src/data/projects.json</code>)
          </p>
        </div>
        <span className="tag">JSON-driven</span>
      </div>
  ...
  return (
    <div className="card mt-8 p-6">
      ...
      <p className="text-slate-300 mt-2 text-sm">
        Add your first project by editing <code>src/data/projects.json</code> and pushing to GitHub.
